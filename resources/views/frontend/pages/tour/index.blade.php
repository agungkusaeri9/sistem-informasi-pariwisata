...
@section('content')
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url({{ asset('assets/frontend/images/pidie.png') }});" data-stellar-background-ratio="0.5">
    <div class="overlay"></div>
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
        <div class="col-md-9 ftco-animate pb-5 text-center">
          <h1 class="mb-3 bread">Destinasi Wisata</h1>
          <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('tour.index') }}"> Nikmati Keindahan Alam Aceh Pidie </a></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row d-flex">
          ...
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry justify-content-end">
              <a href="{{ route('tour.show',$item->slug) }}" class="block-20 w-100">
