...
@section('content')
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url({{ asset('assets/frontend/images/bg_2.jpg') }});" data-stellar-background-ratio="0.5">
      ...
      <div class="container">
          <div class="row d-flex">
              <div class="col-md-6 d-flex">
                  <div class="img d-flex align-self-stretch" style="background-image:url({{ asset('assets/frontend/images/about.jpg') }});"></div>
              </div>
      ...
      <div class="row ftco-animate">
        <div class="col-md-12 testimonial">
          <div class="carousel-testimony owl-carousel ftco-owl">
            <div class="item">
              <div class="testimony-wrap img" style="background-image: url({{ asset('assets/frontend/images/traveler-1.jpg') }});">
                  <div class="overlay"></div>
                <div class="text">
            ...
            <div class="item">
              <div class="testimony-wrap" style="background-image: url({{ asset('assets/frontend/images/traveler-2.jpg') }});">
                  <div class="overlay"></div>
                <div class="text">
                  <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                  <p class="name">Roger Scott</p>
            ...
            <div class="item">
              <div class="testimony-wrap" style="background-image: url({{ asset('assets/frontend/images/traveler-3.jpg') }});">
                  <div class="overlay"></div>
                <div class="text">
                  <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                  <p class="name">Roger Scott</p>
            ...
            <div class="item">
              <div class="testimony-wrap" style="background-image: url({{ asset('assets/frontend/images/traveler-4.jpg') }});">
                  <div class="overlay"></div>
                <div class="text">
                  <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                  <p class="name">Roger Scott</p>
            ...
            <div class="item">
              <div class="testimony-wrap" style="background-image: url({{ asset('assets/frontend/images/traveler-5.jpg') }});">
                  <div class="overlay"></div>
                <div class="text">
                  <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                  <p class="name">Roger Scott</p>
  ...
  <section class="ftco-counter img" id="section-counter">
      <div class="container">
          <div class="row d-flex">
              <div class="col-md-6 order-md-last d-flex">
                  <div class="img d-flex align-self-stretch" style="background-image:url({{ asset('assets/frontend/images/about-1.jpg') }});"></div>
              </div>
      ...
      <section class="ftco-subscribe" style="background-image: url({{ asset('assets/frontend/images/bg_1.jpg') }});">
    <div class="overlay">
      <div class="container">
