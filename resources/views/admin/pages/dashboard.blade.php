                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                Budaya</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $count['culture'] }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                Pesan Masuk</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $count['inbox'] }}</div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped w-100">
                            <thead>
                                ...
                                <tbody>
                                    @forelse ($latest_comments as $latest)
                                    <tr>
                                        <td>{{ $latest->name }}</td>
                                        <td class="text-center">{{ $latest->category->name }}</td>
                                        <td>{{ $latest->comment }}</td>
                                        <td class="text-center">{{ $latest->created_at->translatedFormat('d/m/Y H:i:s') }}</td>
                                    </tr>
                                    @empty
                                    <tr>
