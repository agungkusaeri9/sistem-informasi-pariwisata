            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        <h6>Data Kebudayaan</h6>
                        <a href="{{ route('admin.cultures.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Kebudayaan</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.cultures.edit',$item->id) }}" class="btn btn-sm btn-info"><i class="fas fa-edit"></i></a>
                                    <form action="{{ route('admin.cultures.destroy',$item->id) }}" method="post" class="d-inline">
                                        @csrf
                                        @method('delete')
