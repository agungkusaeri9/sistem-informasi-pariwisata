        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h6 class="text-center">Tambah Vide</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.videos.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="url" class="form-control @error('url') is-invalid @enderror" id="url" value="{{ old('url') }}" placeholder="ex. https://youtube.com">
                            @error('url')
                                <div class="is-invalid">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group d-flex justify-content-between">
                            <a href="{{ route('admin.videos.index') }}" class="btn btn-warning">Batal</a>
